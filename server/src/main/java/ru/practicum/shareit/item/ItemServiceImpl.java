...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    @Transactional
    public ItemDto createItem(ItemCreateDto itemCreateDto, Long ownerId, Long requestId) {
    ...
    public ItemDto updateItemRequest(Long itemId, Long requestId, Long ownerId) {
        Item item = itemRepository.findById(itemId)
                .orElseThrow(() -> new NoSuchElementException("Предмет не найден с id: " + itemId));
